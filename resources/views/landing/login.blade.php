            ...
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div class="cursor-pointer flex items-center">
                        <div>
                        <div class=""><a href="{{ route('home') }}"><img style="width:100%; height:auto; max-width:300px;" src="images/logo/logo-esteh.png" class="logo-banner" alt=""></a></div>
                        </div>
                    </div>
                </div>
                <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    ...
                    <div class="mt-12">
                        <form action="landing/masuk" method="POST">
                            $csrf
                            <div>
                            ...
                            <div class="mt-10">
                                <button name="sibmit" type="submit"class="btn btn-primary bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
